                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="0">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>Get 10% cash back, free shipping, free returns, and more at 1000+ top
                                                retailers!
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="banner-wrapper clearfix">
                        ...
                        <a href="product-details-default.html">
                            <div class="banner-single-item banner-style-7 banner-animation banner-color--green float-left"
                                ...
                                <div class="image">
                                    <img class="img-fluid" src="../assets/images/banner/banner-style-7-img-1.jpg"
                                        alt="">
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="product-details-default.html">
                            <div class="banner-single-item banner-style-7 banner-animation banner-color--green float-left"
                                ...
                                <div class="image">
                                    <img class="img-fluid" src="../assets/images/banner/banner-style-7-img-2.jpg"
                                        alt="">
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="product-details-default.html">
                            <div class="banner-single-item banner-style-7 banner-animation banner-color--green float-left"
                                ...
                                <div class="image">
                                    <img class="img-fluid" src="../assets/images/banner/banner-style-7-img-3.jpg"
                                        alt="">
                                </div>
                            </div>
                        </a>
                                ...
                                <div class="col-12">
                                    <div class="product-slider-default-2rows default-slider-nav-arrow">
                                        ...
                                        <div class="swiper-container product-default-slider-4grid-2row">
                                            <!-- Additional required wrapper -->
                                            <div class="swiper-wrapper" id="newproducts">
                                                ...
                                                <!-- <c:forEach var="item" items="${prod}">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-left">
                                                            <h6 class="title"><a
                                                                    href="product-details.jsp">item.productName </a>
                                                            </h6>
                    ...
                    <div class="banner-wrapper clearfix">
                        ...
                        <a href="product-details-default.html">
                            <div class="banner-single-item banner-style-8 banner-animation banner-color--green float-left"
                                data-aos="fade-up" data-aos-delay="0">
                                <div class="image">
                                    <img class="img-fluid" src="../assets/images/banner/banner-style-8-img-1.jpg"
                                        alt="">
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="product-details-default.html">
                            <div class="banner-single-item banner-style-8 banner-animation banner-color--green float-left"
                                data-aos="fade-up" data-aos-delay="200">
                                <div class="image">
                                    <img class="img-fluid" src="../assets/images/banner/banner-style-8-img-2.jpg"
                                        alt="">
                                </div>
                            </div>
                        </a>
                                                ...
                                                <c:forEach begin="1" end="12">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="image-box">
                                                            ...
                                                            <div class="action-link">
                                                                <div class="action-link-left">
                                                                    <a href="${pageContext.request.contextPath}/caet.jsp"
                                ...
                                <div class="col-12">
                                    <div class="section-content-gap">
                                        <div class="secton-content">
                                            ...
                                            <p>Present posts in a best way to highlight interesting moments of your
                                                blog.
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="swiper-container blog-slider">
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="blog-default-single-item blog-color--pink swiper-slide">
                                                    ...
                                                    <div class="content">
                                                        <h6 class="title"><a href="blog-single-sidebar-left.html">Blog
                                                                Post
                                                                One</a>
                                                        </h6>
                                                        <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras
                                                            ...
                                                            arcu
                                                            ex.
                                                            Aenean posuere libero eu augue condimentum rhoncus. Praesent
                                                        </p>
                                                        <div class="inner">
