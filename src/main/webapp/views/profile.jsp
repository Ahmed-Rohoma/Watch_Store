                                        ...
                                        <div class="login_form_container">
                                            <div class="account_login_form">
                                                ...
                                                <div class="default-form-box mb-20">
                                                    <label>Name</label>
                                                    <input type="text" id="txtName" value="${sessionScope.userData.getUserName()}" name="name">
                                                </div>
                                                <div class="default-form-box mb-20">
                                                    <label>Email</label>
                                                ...
                                                <div class="default-form-box mb-20">
                                                    ...
                                                    <input type="password" id="txtPassword" value="${sessionScope.userData.getPassword()}" name="user-password">
                                                </div>
                                                <div class="default-form-box mb-20">
                                                    <label>Job</label>
                                                    <input type="text" id="txtJob" value="${sessionScope.userData.getJob()}" name="user-job">
                                                </div>
                                                <div class="default-form-box mb-20">
                                                    <label>Birthdate</label>
                                                    <input type="date" id="txtBirthday" value="${sessionScope.userData.getBirthdate()}" name="birthday">
                                                </div>
                                                <div class="default-form-box mb-20">
                                                    <label>Address</label>
                                                    <input type="text" id="txtAddress" value="${sessionScope.userData.getAddress()}" name="user-address">
                                                </div>
                                                <div class="default-form-box mb-20">
                                                    <label>Interests</label>
                                                    <input type="text" id="txtInterests" value="${sessionScope.userData.getInterests()}" name="user-interests">
                                                </div>
                                                <div class="default-form-box mb-20">
                                                    <label>Credit Limit</label>
                                                    <input type="number" id="txtCreditLimit" value="${sessionScope.userData.getCreditLimit()}" name="user-creditlimit">
                                                </div>
