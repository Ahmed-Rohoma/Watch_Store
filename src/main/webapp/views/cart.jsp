<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <%@ page import="gov.iti.jets.model.CartItemModel" %>

            <% 
            // Get the cart from the session 
            List<CartItemModel> cart = (List<CartItemModel>)session.getAttribute("cart");
                    %>
                    <% String opt=( String ) session.getAttribute("Name"); System.out.println("\n selected optiion is:"+opt); %>
                        <!DOCTYPE html>
                        <html lang="zxx">
                                                            ...
                                                            <div
                                                                ...
                                                                <nav aria-label="breadcrumb">
                                                                    <ul>
                                                                        ...
                                                                        <li><a
                                                                                href="shop-grid-sidebar-left.html">Shop</a>
                                                                        </li>
                                                                                    ...
                                                                                    <c:forEach var="item"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="product_name"><a
                                                                                                    ...
                                                                                                    <c:out
                                                                                                        value="${item.productModel.productName}" />
                                                                                                </a></td>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <!-- Add Arrows -->
                                                                                    <div
                                                                                        class="gallery-thumb-arrow swiper-button-next">
                                                                                    </div>
                                                                                    <div
                                                                                        class="gallery-thumb-arrow swiper-button-prev">
                                                                                    </div>
                                                                                </div>
                                                                                <!-- End Thumbnail Image -->
                                                                            </div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="modal-product-about-text">
                                                                                    <p>Lorem ipsum dolor sit amet,
                                                                                        ...
                                                                                        Mollitia
                                                                                        iste
                                                                                        laborum ad impedit pariatur esse
                                                                                        optio
                                                                                        tempora
                                                                                        sint
                                                                                        ullam
